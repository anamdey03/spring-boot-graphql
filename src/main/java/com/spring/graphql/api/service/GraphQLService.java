...
import com.spring.graphql.api.service.datafetcher.AllBooksDataFetcher;
import com.spring.graphql.api.service.datafetcher.BookDataFetcher;
...
public class GraphQLService {
	...
	private void loadDataIntoHSQL() {
		Stream.of(new Book("123", "Book of clouds", "Kindle Edition", new String[] { "Chloe Aridjis" }, "Nov 2017"),
				new Book("124", "Cloud Arch & Engineer", "Orielly", new String[] { "Peter", "Sam" }, "Jan 2015"),
